 ...
 * @author vodoa
 */
public class Add_DichVuController implements Initializable {

    private TextField tfTenDV;
    private TextField tfGiaDV;
    @FXML
    ...
    private void insertEvent(MouseEvent event) {
        ...
        int giaDV = parseInt(tfGiaDV.getText());
        String GhiChu = tfGhiChu.getText();
        
        if (tenDV.isEmpty()||GhiChu.isEmpty()||tfGiaDV.getText().isEmpty()){
            ...
            try {
                ...
                preparedStatement = connection.prepareStatement("INSERT INTO `quanliphongkham`.`dichvu` (`tenDV`, `giaDV`,`ghichu`) VALUES (?,?,?);");
                preparedStatement.setString(1, tenDV);
                preparedStatement.setInt(2, giaDV);
                ...
                Stage thisStage = (Stage) tfTenDV.getScene().getWindow();
